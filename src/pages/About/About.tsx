...
export const About = () => {
    return (
        ...
        />
            <div>
                <h1 className="font-inter font-bold text-[52px] tracking-tight mb-6">Про кафедру</h1>
                <Paragraph>Кафедра інтелектуальних програмних систем спеціалізується в області комп'ютерних наук, штучного інтелекту та програмної інженерії. Завідувач кафедри - доктор фізико-математичних наук, професор Провотар О.І.</Paragraph>
            </div>
            ...
            <div>
                <p className="font-inter font-light text-[32px] tracking-tight mb-5">Нині співробітники забезпечують підготовку бакалаврів за спеціальностями:</p>
            ...
            <div className="font-inter font-medium text-[48px] tracking-tight max-w-[50rem]">
            ...
            <div>
                <div className="font-inter font-medium text-[32px] tracking-tight mb-5">Навчаючись на інтелектуальних програмних систем ви зможете:</div>
